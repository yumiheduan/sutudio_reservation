    ...
    <div class="container-md">
        ...
        <div class="col-md-6 offset-md-3">
            <div class="alert alert-success" role="alert">
                <strong>予約削除完了</strong> -- 処理を選択してください --
            </div>
            <!-- アラート ここまで -->
                    ...
                    <div class="card border-success">
                        ...
                        <div class="card-body text-success">
                            ...
                            ?>
                                ...
                                <div class="row my-2">
                                    <div class="my-2">
                                        <a class="btn btn-secondary mb-3" href="#" onclick="history.back(); return false;">前へ戻る</a>
                                        <a class="btn btn-success mb-3" href="../reservation/registration.php">予約入力</a>
                                        <a class="btn btn-outline-secondary mb-3" href="../members/unset.php">処理終了</a>
                                    </div>
                                </div>
                                <!-- 送信ボタン ここまで -->
                            <?php endif ?>

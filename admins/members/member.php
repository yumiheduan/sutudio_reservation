...
// サニタイズ
$get = CommonUtil::sanitize($_GET);

// GETされてきた値をセッション変数に保存する
$_SESSION['get']['member_id'] = $get['member_id'];
...
if (empty($members)) {
    $_SESSION['msg']['err'] = '条件に該当する会員情報はありません。';
    ...
    <div class="container-md">
        ...
        <div class="col-md-6 offset-md-3">
            <div class="alert alert-success" role="alert">
                <strong>会員情報</strong> -- 処理を選択してください --
            </div>
            <!-- アラート ここまで -->

    ...
    <div class="container-md">
        ...
        <div class="col-md-6 offset-md-3">
            <div class="alert alert-success" role="alert">
                <strong>会員情報変更確認</strong> -- 変更内容を確認して下さい --
            </div>
        </div>
        <!-- アラート ここまで -->
            ...
            <div class="col-md-6 offset-md-3">
                <div class="card border-success">
                    <div class="card-body text-success">
                        ...
                        <div class="row my-2">
                            <div class="my-6">
                                <a class="btn btn-outline-secondary mb-3" href="./update.php">前へ戻る</a>
                                <a class="btn btn-success mb-3" href="./update_process.php">情報変更</a>
                            </div>
                        </div>
